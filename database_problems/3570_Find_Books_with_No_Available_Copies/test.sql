...
*/
-- Final SQL command --
with num_borrowers as (
select book_id, count(*) current_borrowers 
from borrowing_records 
where return_date is null
group by book_id)
select lb.book_id, title, author, genre, publication_year, nb.current_borrowers
from library_books lb
join num_borrowers nb
on lb.book_id = nb.book_id
where nb.current_borrowers = total_copies 
order by nb.current_borrowers desc, title;