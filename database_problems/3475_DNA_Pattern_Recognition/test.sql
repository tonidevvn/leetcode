...
select sample_id, dna_sequence, species, 
    ...
    (case
        when dna_sequence LIKE 'ATAT%' or dna_sequence LIKE '%ATAT' or dna_sequence LIKE '%ATAT%' then 1
        else 0
    end) as has_atat,
    (case
        when dna_sequence LIKE 'GGG%' or dna_sequence LIKE '%GGG' or dna_sequence LIKE '%GGG%' then 1
        else 0
    end) as has_ggg
from samples
order by sample_id;